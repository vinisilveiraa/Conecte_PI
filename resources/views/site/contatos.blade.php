    ...
    <div class="container">
        ...
        <div class="contact-section">
            ...
            <div class="contact-item">
                <h3>
                    <span
                        style="display: inline-flex; align-items: center; justify-content: center; width: 30px; height: 30px; color: var(--color-text);">
            ...
            <div class="contact-item">
                <h3>
                    <span
                        style="display: inline-flex; align-items: center; justify-content: center; width: 20px; height: 20px; color: var(--color-text);">
                ...
                <a href="https://maps.google.com/?q=Faculdade+de+Tecnologia+de+Jahu" target="_blank"
