 ...
 * Informações sobre proteção de dados e privacidade do usuário
 */

$current_page = 'politica-privacidade';
?>
...
<head>
  ...
  <title>Política de Privacidade - Conecte</title>
...
<body>
  ...
  <main class="politica-container">
    <div class="politica-header">
      <svg class="politica-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
    ...
    <div class="politica-content">
      <div class="politica-intro">
        <p><strong>Bem-vindo ao Conecte.</strong> Esta Política de Privacidade descreve como coletamos, usamos e protegemos as suas informações.</p>
      </div>
