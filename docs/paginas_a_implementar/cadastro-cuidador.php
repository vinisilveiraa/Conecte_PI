...
/**
 * PÁGINA: CADASTRO CUIDADOR
 * Formulário de cadastro para cuidadores que oferecem serviços
 */

$current_page = 'cadastro-cuidador';
?>
...
<head>
  ...
  <title>Cadastro Cuidador - Conecte</title>
...
<body>
          ...
          <div class="form-section">
            ...
            <div class="form-row">
              ...
              <div class="form-group">
                ...
                <input type="number" id="valor-hora" name="valor-hora" placeholder="">
              </div>
            </div>
            ...
            <div class="form-row" style="grid-template-columns: 1fr;">
              <div class="form-group">
                ...
                <input type="file" id="certificado" name="certificado" accept="application/pdf ,image/*">
              </div>
            </div>
          </div>
  ...
  <script>
    /**
     * Funcionalidade para inputs de arquivo
     */
    document.querySelectorAll('.btn-file-input').forEach(button => {
    ...
    document.querySelectorAll('input[type="file"]').forEach(input => {
      input.addEventListener('change', function() {
        const fileName = this.files.length > 0 ? this.files[0].name : 'Nenhum_colhido';
