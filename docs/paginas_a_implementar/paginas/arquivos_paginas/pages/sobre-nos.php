...
/**
 * PÁGINA SOBRE NÓS
 * Informações sobre o projeto e colaboradores
 */
...
<body>
  ...
  <section class="section">
    <div class="container">
      ...
      <div style="background-color: var(--color-light-gray); padding: 2rem; border-radius: 1rem; max-width: 900px; margin: 0 auto;">
        <p>
          Este projeto foi criado por alunos da <strong>FATEC Jahu</strong> com o propósito de aproximar pessoas. Acreditamos que cuidado é um ato humano e essencial — e que encontrar alguém de confiança não deveria ser difícil.
        </p>
        <p>
          Por isso, desenvolvemos uma plataforma que facilita a conexão entre cuidadores capacitados e quem precisa de assistência, prezando pela segurança, acolhimento e respeito.
        </p>
      </div>
    </div>
  </section>
    ...
    <div class="container">
      <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(250px, 1fr)); gap: 2rem;">
        ...
        <div class="card card-icon">
          <div class="icon">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><!--!Font Awesome Free v7.2.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2026 Fonticons, Inc.-->
              <path d="M448 256a192 192 0 1 0 -384 0 192 192 0 1 0 384 0zM0 256a256 256 0 1 1 512 0 256 256 0 1 1 -512 0zm256 80a80 80 0 1 0 0-160 80 80 0 1 0 0 160zm0-224a144 144 0 1 1 0 288 144 144 0 1 1 0-288zM224 256a32 32 0 1 1 64 0 32 32 0 1 1 -64 0z" fill="currentColor" />
            </svg>
          </div>
          <h3>Missão</h3>
        ...
        <div class="card card-icon">
          <div class="icon">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><!--!Font Awesome Free v7.2.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2026 Fonticons, Inc.-->
              <path d="M128 320L24.5 320c-24.9 0-40.2-27.1-27.4-48.5L50 183.3C58.7 168.8 74.3 160 91.2 160l95 0c76.1-128.9 189.6-135.4 265.5-124.3 12.8 1.9 22.8 11.9 24.6 24.6 11.1 75.9 4.6 189.4-124.3 265.5l0 95c0 16.9-8.8 32.5-23.3 41.2l-88.2 52.9c-21.3 12.8-48.5-2.6-48.5-27.4L192 384c0-35.3-28.7-64-64-64l-.1 0zM400 160a48 48 0 1 0 -96 0 48 48 0 1 0 96 0z" fill="currentColor" />
            </svg>
          </div>
          <h3>Visão</h3>
          <p>Ser a principal plataforma de conexão de cuidado no Brasil, referência em confiança e acolhimento.</p>
        </div>
    ...
    <div class="container">
      ...
      <div class="collaborator">
        ...
        <div class="collaborator-content">
          ...
          <div class="collaborator-role">Desenvolvimento back-end</div>
      ...
      <div class="collaborator">
        <div style="text-align: right; flex: 1;">
          ...
          <div class="collaborator-role">Desenvolvimento front-end</div>
