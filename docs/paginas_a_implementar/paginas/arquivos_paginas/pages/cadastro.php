...
/**
 * PÁGINA CADASTRO
 * Página com opções de cadastro para cuidador ou pessoa que precisa
 */
...
<body>
  ...
  <section class="section">
    <div class="container">
      ...
      <!-- Cards de Cadastro -->
      <div style="display: flex; flex-wrap: wrap; justify-content: space-evenly; gap: var(--spacing-xl); margin-bottom: 4rem; justify-items: center;">
        ...
        <div class="card card-list" style="border-top: 4px solid var(--color-primary);">
          ...
          <a href="cadastro-cliente.php" class="btn btn-primary btn-md btn-block">
            Preciso de um
          </a>
        </div>
        ...
        <div class="card card-list" style="border-top: 4px solid var(--color-secondary);">
          ...
          <a href="cadastro-cuidador.php" class="btn btn-secondary btn-md btn-block">
            Seja Cuidador
          </a>
        </div>
      </div>
    ...
    <div class="container">
      ...
      <div class="steps">
        ...
        <div class="card" style="position: relative;">
          ...
          <div style="display: flex; align-items: center; justify-content: center; margin-bottom: var(--spacing-md); padding-top: var(--spacing-sm);">
