...
<footer class="footer">
  <div class="footer-container">
    <div class="footer-content">
      ...
      <div class="footer-section">
        <div class="footer-brand">
          ...
          <span style="font-weight: bold; font-size: 2rem;">Conecte</span>
        </div>
        <p class="footer-tagline">Simples, Rápido e Humano</p>

        <!-- Redes Sociais -->
        <div class="footer-social">
          <a href="https://wa.me/5514999999999" target="_blank" class="footer-social-link" title="WhatsApp">
          ...
          <a href="https://instagram.com/conecte" target="_blank" class="footer-social-link" title="Instagram">
          ...
          <a href="https://facebook.com/conecte" target="_blank" class="footer-social-link" title="Facebook">
    ...
    <div class="footer-divider">
      © 2025 Conecte — Todos os direitos reservados
    </div>
  </div>
</footer>