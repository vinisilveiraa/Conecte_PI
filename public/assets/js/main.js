...
// ============================================
// Ocultar alerts dps de um tempo
// ============================================
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    cepInput.addEventListener('blur', async function () {
        ...
        try {
            ...
            const geoRes = await fetch(`/geocode?endereco=${encodeURIComponent(`${data.logradouro}, ${data.localidade}, ${data.uf}, Brasil`)}`);
            ...
            console.error('Erro ao buscar CEP/geocode:', error);
        }
    });
